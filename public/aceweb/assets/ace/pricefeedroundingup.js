            ...
            try {
              ...
              // var gp_livesellprice_gm   = (Math.round(json[1].gp_livesellprice_gm * 100) / 100).toFixed(3);
               ...
               if(gp_livebuyprice_gm > oldbuy){
                 ...
                 document.getElementById("gp_livebuyprice_gm").innerHTML = Math.ceil(json[1].gp_livebuyprice_gm).toFixed(2);
                 //document.getElementById("gp_livebuyprice_gm_mobile").innerHTML = (Math.round(json[1].gp_livebuyprice_gm * 100) / 100).toFixed(3);
                 document.getElementById("gp_livebuyprice_gm_mobile").innerHTML = Math.ceil(json[1].gp_livebuyprice_gm).toFixed(2);
               ...
               if(gp_livesellprice_gm > oldsell){
                  ...
                  document.getElementById("gp_livesellprice_gm").innerHTML = Math.ceil(json[1].gp_livesellprice_gm).toFixed(2);
                  //document.getElementById("gp_livesellprice_gm_mobile").innerHTML = (Math.round(json[1].gp_livesellprice_gm * 100) / 100).toFixed(3);
                  document.getElementById("gp_livesellprice_gm_mobile").innerHTML = Math.ceil(json[1].gp_livesellprice_gm).toFixed(2);
               }
