            ...
            <table class="table mb-0 aiz-table">
                ...
                <tbody>
                 ...
                 <tr>
                    ...
                    <td>
                        @can('edit_downloads')
                                <a class="btn btn-soft-primary btn-icon btn-circle btn-sm"  href="{{ route('downloads.edit',base64_encode($v->id))}}" title="{{ translate('Edit') }}">
                                    <i class="las la-pen"></i>
                                </a>
                            @endcan
                            @can('delete_downloads')
                                <a  class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" data-href="{{route('downloads.destroy', base64_encode($v->id))}}" title="{{ translate('Delete') }}">
