    ...
    <div class="aiz-sidebar left c-scrollbar">
        <div class="aiz-side-nav-logo-wrap">
            <a href="{{ route('admin.dashboard') }}" class="d-block text-left">
                ...
                @else
                    <img class="mw-100" src="{{ uploaded_asset(get_setting('site_icon')) }}" class="brand-icon" alt="{{ get_setting('site_name') }}">
                @endif
                ACE ADMIN PANEL
            </a>
        </div>
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a class="aiz-side-nav-link" href="{{route('pricefeed.set')}}">
                                    <span class="aiz-side-nav-text">{{translate('Pice Override')}}</span>
                                </a>
                            </li>
                            @endcan
                           {{-- @can('add_new_product')
                ...
                @canany(['view_blogs','view_blog_categories'])
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                             @can('view_slider')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('slider.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['slider.create', 'slider.edit'])}}">
                            ...
                            @can('view_about')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('about.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['about.create', 'about.edit'])}}">
                            ...
                            @endcan
                             @can('view_testimonial')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('testimonial.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['testimonial.create', 'testimonial.edit'])}}">
                            ...
                            @can('view_patners')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('patners.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['patners.create', 'patners.edit'])}}">
                            ...
                            @can('view_requestpatner')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('requestpatner.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['requestpatner.create', 'requestpatner.edit'])}}">
                            ...
                            @can('view_providers')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('providers.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['providers.create', 'providers.edit'])}}">
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                         @can('view_personalpageset')
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('personalpageset.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['perseonalpageset.edit'])}}">
                        ...
                        @endcan
                         @can('view_personaltestimonial')
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('personaltestimonial.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['personaltestimonial.create','personaltestimonial.edit'])}}">
                                    <span class="aiz-side-nav-text">{{ translate('Testimonial') }}</span>
                                </a>
                            </li>
                        @endcan
                ...
                @canany(['view_investor','view_messagefromceo'])
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('investor.bannerset') }}" class="aiz-side-nav-link {{ areActiveRoutes(['investor.bannerset'])}}">
                            ...
                            @endcan
                             @can('view_messageceo')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('messagefromceo.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['messagefromceo.create', 'messagefromceo.edit'])}}">
                            ...
                            @endcan
                             @can('view_announcements')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('announcements.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['announcements.create', 'announcements.edit'])}}">
                            ...
                            @endcan
                             @can('view_downloads')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('downloads.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['downloads.create', 'downloads.edit'])}}">
                            ...
                            @can('view_ir_persentation')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('persentation.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['persentation.create', 'persentation.edit'])}}">
